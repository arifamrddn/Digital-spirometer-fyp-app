...
export default class TestFev extends React.Component {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.sTestText}>FEV1</Text>
      <Text style={styles.sTestText2}>1.take a deep breath</Text>
      <Text style={styles.sTestText2}>2. exhale as hard and as long as you can when you press the start button until </Text>
